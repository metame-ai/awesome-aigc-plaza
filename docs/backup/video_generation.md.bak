...
- **$\nabla$NABLA: Neighborhood Adaptive Block-Level Attention**, `arXiv, 2507.13546`, [arxiv](http://arxiv.org/abs/2507.13546v1), [pdf](http://arxiv.org/pdf/2507.13546v1.pdf), cication: [**-1**](None) 

	 *Dmitrii Mikhailov, Aleksey Letunovskiy, Maria Kovaleva, ..., Evelina Sidorova, Denis Dimitrov*
...
- **Video-T1: Test-Time Scaling for Video Generation**, `arXiv, 2503.18942`, [arxiv](http://arxiv.org/abs/2503.18942v2), [pdf](http://arxiv.org/pdf/2503.18942v2.pdf), cication: [**-1**](None) 

	 *Fangfu Liu, Hanyang Wang, Yimo Cai, ..., Xiaohang Zhan, Yueqi Duan* · ([liuff19.github](https://liuff19.github.io/Video-T1/)) · ([Video-T1](https://github.com/liuff19/Video-T1) - liuff19) ![Star](https://img.shields.io/github/stars/liuff19/Video-T1.svg?style=social&label=Star)
- **Wan: Open and Advanced Large-Scale Video Generative Models**, `arXiv, 2503.20314`, [arxiv](http://arxiv.org/abs/2503.20314v1), [pdf](http://arxiv.org/pdf/2503.20314v1.pdf), cication: [**-1**](None) 

	 *WanTeam, :, Ang Wang, ..., Zhi-Fan Wu, Ziyu Liu* · ([Wan2.1.](https://github.com/Wan-Video/Wan2.1.) - Wan-Video) ![Star](https://img.shields.io/github/stars/Wan-Video/Wan2.1..svg?style=social&label=Star)
- **One-Minute Video Generation with Test-Time Training**, `arXiv, 2504.05298`, [arxiv](http://arxiv.org/abs/2504.05298v1), [pdf](http://arxiv.org/pdf/2504.05298v1.pdf), cication: [**-1**](None) 

	 *Karan Dalal, Daniel Koceja, Gashon Hussein, ..., Yu Sun, Xiaolong Wang* · ([test-time-training.github](https://test-time-training.github.io/video-dit/)) · ([ttt-video-dit](https://github.com/test-time-training/ttt-video-dit) - test-time-training) ![Star](https://img.shields.io/github/stars/test-time-training/ttt-video-dit.svg?style=social&label=Star)
