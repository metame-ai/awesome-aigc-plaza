...
- **Towards World Simulator: Crafting Physical Commonsense-Based Benchmark
  for Video Generation**, `arXiv, 2410.05363`, [arxiv](http://arxiv.org/abs/2410.05363v1), [pdf](http://arxiv.org/pdf/2410.05363v1.pdf), cication: [**-1**](None)

	 *Fanqing Meng, Jiaqi Liao, Xinyu Tan, Wenqi Shao, Quanfeng Lu, Kaipeng Zhang, Yu Cheng, Dianqi Li, Yu Qiao, Ping Luo* · ([phygenbench123.github](https://phygenbench123.github.io/)) · ([PhyGenBench](https://github.com/OpenGVLab/PhyGenBench) - OpenGVLab) ![Star](https://img.shields.io/github/stars/OpenGVLab/PhyGenBench.svg?style=social&label=Star)
- [**MovieGenBench**](https://github.com/facebookresearch/MovieGenBench) - facebookresearch ![Star](https://img.shields.io/github/stars/facebookresearch/MovieGenBench.svg?style=social&label=Star)
...
- **Progressive Autoregressive Video Diffusion Models**, `arXiv, 2410.08151`, [arxiv](http://arxiv.org/abs/2410.08151v1), [pdf](http://arxiv.org/pdf/2410.08151v1.pdf), cication: [**-1**](None)
	 ...
	 *Desai Xie, Zhan Xu, Yicong Hong, Hao Tan, Difan Liu, Feng Liu, Arie Kaufman, Yang Zhou* · ([desaixie.github](https://desaixie.github.io/pa-vdm/))
